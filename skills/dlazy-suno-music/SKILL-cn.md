...
Options:
  --mode [mode]                        模式 [default: inspiration] (choices: "inspiration", "custom")
  --prompt [prompt]                    提示词 [default: ]
  --title [title]                      标题（自定义） [default: ] [only when mode="custom"]
  --tags [tags...]                     标签 (max 20) [only when mode="custom"]
  --make_instrumental [make_instrumental]纯音乐（无人声） [default: false] [only when mode="inspiration"]
