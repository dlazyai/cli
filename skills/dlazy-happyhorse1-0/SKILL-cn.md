...
Options:
  --prompt [prompt]                    提示词
  --generation_mode [generation_mode]  生成模式（t2v=文生; i2v=首帧; r2v=参考图; edit=编辑） [default: t2v] (choices: "t2v", "i2v", "r2v", "edit")
...
```bash
dlazy happyhorse1-0 --prompt '提示词内容'
```
